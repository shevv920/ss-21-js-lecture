...
---
![js](http://risovach.ru/upload/2016/09/mem/povsyudu_125652353_orig_.jpg)
---
## Как работают движки?
...
- Например поиск элемента в массиве вернет `undefined`
```JS
const arr = [1, 2, 3];
...
```
![js](https://www.freecodecamp.org/news/content/images/2019/07/this-is-javascript.jpeg)
---
```Javascript
...
anotherConfig.password = '';
 // изменено по ссылке из переменной "config"
```
---
...
```JS
const a = {};
const b = a; // копирование по ссылке
a === b; // true
a == b; // true

const a = {};
const b = {}; // два независимых объекта
...
---
### Map & Set
- Иногда помимо массивов и объектов нужны другие структуры данных
...
```
---
![here we go again](https://i.ytimg.com/vi/NnodVR_Jgqs/maxresdefault.jpg)
---
### Promise
...
```
---
![meme](https://www.meme-arsenal.com/memes/426a6126bdaa7d0cb899fb6ad4be249d.jpg)
---
![meme](http://memesmix.net/media/created/ordn8p.jpg)
---
```JS
...
- строки, числа, массивы, объекты и другие
---
 - Lodash позволяет использовать готовые функции для например:
   - сравнения массивов и объектов
   - полное копирование объектов
   - экранизация регулярных выражений
   - объединения массивов и объектов
   - обход и отображение массивов и объектов
---
...
---
#### Babel 
- Babel это набор инструментов для конвертации современно JavaScript (ECMAScript2015+) кода в обратно совместимую версию.
